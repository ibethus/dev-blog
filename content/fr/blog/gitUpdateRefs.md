...
## Empilement ?
L'empilement de branches est une façon de morceller des _features_ importantes, ce qui permet notamment de créer de plus petites _pull request_.
...
## La solution
### update-refs
L'objectif de cette option est de mettre automatiquement à jour les _n_ branches dont dépent la branche que l'on cherche à _rebase_.
...
Le message indiquant la bonne exécution de la commande est explicite : 

```bash
git rebase ma-feature-v1 --update-refs
Successfully rebased and updated refs/heads/ma-feature-v3.
Updated the following refs with --update-refs:
        refs/heads/ma-feature-v2
```
...
> L'option -f est nécessaire puisque des modification d'historiques ont été faites lors du _rebase_

### Activation globale
Pourquoi ne pas toujours utiliser l'option `update-refs` lors d'un _rebase_ ? L'équipe de git s'est posé la même question et y a répondu en incluant cette possibilité dans la configuration. 
